...
# Start cachy in headless mode in order to create config directory for it.
mkdir -p $HOME/.cachy
cachy-browser --headless >/dev/null 2>&1 &
sleep 3
killall cachy-browser

# Find the profile folder.
LIBREW_CONFIG_DIR="$HOME/.cachy"
