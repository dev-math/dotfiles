...
nnoremap <silent> gcc :call VSCodeCommentary<CR>
vnoremap <silent> gcc :call VSCode<CR>

nnoremap <silent> <C-w>_ :<C-u>call VSCodeNotify('workbench.action.toggleEditorWidths')<CR>

nnoremap <C-b> :call VSCodeNotify('workbench.action.toggleSidebarVisibility')<CR>
xnoremap <C-b> :call VSCodeNotify('workbench.action.toggleSidebarVisibility')<CR>
