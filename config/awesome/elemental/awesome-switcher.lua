...
_M.settings = {
	...
	preview_box_fps = 30,
	preview_box_delay = 0, -- default 150
	...
	cycle_raise_client = false, -- raise (bring to front) selected clients while tabbing
}
